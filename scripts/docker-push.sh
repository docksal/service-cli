...
IMAGE_TAG_EDGE="edge${SOFTWARE_VERSION}"  # e.g., edge[-SOFTWARE_VERSION]
IMAGE_TAG_STABLE="stable${SOFTWARE_VERSION}"  # e.g., stable[-SOFTWARE_VERSION]
IMAGE_TAG_RELEASE_MAJOR="${VERSION_MAJOR}${SOFTWARE_VERSION}"  # e.g., 2[-SOFTWARE_VERSION]
IMAGE_TAG_RELEASE_MAJOR_MINOR="${VERSION_MAJOR}.${VERSION_MINOR}${SOFTWARE_VERSION}"  # e.g., 2.7[-SOFTWARE_VERSION]
